...
const assetsPlugin = () => async ({ logger, config, cwd }) => {
...
async function generateAndroidIcons(sourcePath, outputDir, logger) {
    const androidSizes = [
...
async function generatePWAIcons(sourcePath, outputDir, logger) {
    const pwaSizes = [
...
async function generateFavicons(sourcePath, outputDir, logger) {
